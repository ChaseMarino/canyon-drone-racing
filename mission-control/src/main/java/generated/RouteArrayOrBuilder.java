...
public interface RouteArrayOrBuilder extends
   ...
   */
  java.util.List<generated.RoutePoint> 
      getWaypointsList();
  /**
   * <code>repeated .tutorial.RoutePoint waypoints = 1;</code>
   */
  generated.RoutePoint getWaypoints(int index);
  /**
   * <code>repeated .tutorial.RoutePoint waypoints = 1;</code>
   */
   ...
   * <code>repeated .tutorial.RoutePoint waypoints = 1;</code>
   */
  java.util.List<? extends generated.RoutePointOrBuilder> 
      getWaypointsOrBuilderList();
  /**
   * <code>repeated .tutorial.RoutePoint waypoints = 1;</code>
   */
  generated.RoutePointOrBuilder getWaypointsOrBuilder(
      int index);
}
